...
{
    /// <summary>
    /// Represents a decomposed, logical JSON object.
    /// This class acts as a bridge between JSON strings and a higher-level interpretation of the data contained in it.
    /// An instance of this class will contain exactly one JSON data item (of one of the types enumerated in Type), and may contain nested JsonObjects (as in the case of Dictionary and Array data).
    /// </summary>
    public class JsonObject
    {
        ...
        public static JsonObject Parse(string json)
        {
            ...
            using (var ms = new MemoryStream(buffer))
            {
                ...
                JsonObject obj = parser.ReadObject().Result;
                if (parser.BytesProcessed != buffer.Length)
